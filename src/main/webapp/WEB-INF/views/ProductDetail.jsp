...
<span class="fa fa-star checked"></span>
<div class="clear spaces20"></div>
<span><i class="productdes"> ${product.getProductDesc()}</i></span>
...
<div class="form-group">
<a href="${pageContext.request.contextPath}/AllProducts" class="btn btn-cntu" id="continueshop" style="margin-bottom: -118px;"> BACK</a>
